...
hittable_list cornell_box() {
	...
	box1 = make_shared<translate>(box1, vec3(265, 0.1, 295));
	objects.add(box1);

	shared_ptr<hittable> box2 = make_shared<box>(point3(0, 0, 0), point3(165, 165, 165), white);
	box2 = make_shared<rotate_y>(box2, -18);
	box2 = make_shared<translate>(box2, vec3(130, 0.1, 65));
	objects.add(box2);
...
int main(int argc, char** argv) {
	...
	auto worker = [MAX_THREAD, samples_per_pixel, &world, max_depth, &cam, background](int arg)
	{
		int i, j, old_j;
