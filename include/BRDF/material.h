...
public:
	IMPORT_TYPES_L3
		...
		GlassMaterial(const std::shared_ptr<Texture<UnpolarizedSpectrum>>& Kr,
			const std::shared_ptr<Texture<UnpolarizedSpectrum>>& Kt,
...
private:
	...
	std::shared_ptr<Texture<UnpolarizedSpectrum>> Kr, Kt;
...
private:
	...
	std::shared_ptr<Texture<UnpolarizedSpectrum>> eta, k;
