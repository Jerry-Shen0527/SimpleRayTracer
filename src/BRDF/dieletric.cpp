...
bool dielectric::scatter(const Ray& r_in, const SurfaceInteraction& rec, scatter_record& srec) const
{
	...
	{
		Vector3f reflected = reflect(unit_direction, rec.n);
	...
	Vector3f refracted = refract(unit_direction, rec.n, etai_over_etat);
