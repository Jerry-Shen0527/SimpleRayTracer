...
std::vector<std::shared_ptr<Shape>> CreateBox(const Transform* ObjectToWorld, const Transform* WorldToObject, bool reverseOrientation, const Point3f& p1, const Point3f& p2,
	const Vector3f* s = nullptr, const Normal3f* n = nullptr, const Point2f* uv = nullptr,
	const std::shared_ptr<Texture<Float>>& alphaMask = nullptr);